...
1. data
   1.1 GestorEntidades: Clase que representa al gestor de datos de las personas registradas en el sistema.
2. model
   2.1 Cliente: Clase herencia de Entidad que representa a un cliente con su nombre, rut y, como dato específico, nacionalidad.
   ...
   2.3 Proveedor: Clase herencia de Entidad que representa a un proveedor con su nombre (de empresa), rut (de empresa) y, como dato específico, giro empresarial.
...
Esta interfaz es implementada por la clase Entidad y por herencia sus tres clases hijas (Cliente, Trabajador y Proveedor).
   2.5 Rut: Clase que representa el rut de la persona con su formato y validador.
   2.6 Trabajador: Clase herencia de Entidad que representa a un trabajador con su nombre, rut y, como dato específico, sección laboral.
3. ui
...
4° El programa mostrará una ventana en donde se dispone un menú desplegable, campos de texto, botones de control y pantalla para mostrar información.
